  ...
  try {
    ...
    const voiceInstructions =
      language === "fr"
        ...
        : "تحدث بلهجة سعودية بيضاء طبيعية تميل لنجد، بصوت أنثوي واضح ومشرق وغير مكتوم. تكلم بسرعة طبيعية نشيطة وأسرع من المتوسط قليلًا، مع وقفات قصيرة جدًا بين الجمل ومن دون تمطيط أو بطء. حافظ على وضوح الحروف والكلمات ولا تبتلع النهايات. استخدم تعبيرات سعودية يومية بشكل طبيعي مثل: هلا، وش ودك، أبشر، تمام، من عيوني. لا تستخدم اللهجة المصرية أو الشامية أو التونسية، ولا تستخدم فصحى رسمية إلا عند الحاجة. اجعل الأداء مثل نادلة سعودية شابة وراقية، دافئة وواثقة وسريعة الاستجابة ومن دون مبالغة أو تمثيل.";
