...
check("Customer assets are version-busted", customerHtml.includes("customer.css?v=6.0.5") && customerHtml.includes("customer-app.js?v=6.0.5"));
check("Dashboard assets are version-busted", dashboardHtml.includes("dashboard.css?v=6.0.5") && dashboardHtml.includes("dashboard-app.js?v=6.0.5"));
