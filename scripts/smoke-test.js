...
check("Customer assets are version-busted", customerHtml.includes("customer.css?v=6.0.10") && customerHtml.includes("customer-app.js?v=6.0.10"));
check("Dashboard assets are version-busted", dashboardHtml.includes("dashboard.css?v=6.0.10") && dashboardHtml.includes("dashboard-app.js?v=6.0.10"));
...
// v6.0.10 Cartesia playground-parity integration static checks
{
  ...
  if (!sara.includes('generation_config: { volume: 1, speed: 1 }')) throw new Error('Cartesia default speed parity missing');
